...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-cart { background-color: #555; color: #fff; }
        .badge-wishlist { background-color: #888; color: #fff; }
...
<body>
    ...
    @else
        ...
        <div class="empty-state">
            <p style="font-size: 24pt; margin-bottom: 10px;">&mdash;</p>
    ...
    @endif
        ...
        <!-- Footer -->
    <div class="footer">
        <span>Nykaa Marketplace &mdash; Product Analytics Report &mdash; Generated on {{ date('d F Y, h:i A') }}</span>
    </div>
